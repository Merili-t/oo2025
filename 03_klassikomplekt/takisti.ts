class Resistor{
    ...
    constructor(protected r: number, protected g: CanvasRenderingContext2D, 
    ...
    draw(){
        this.g.clearRect(this.startx, this.y-this.height*2/3-15 , this.width, this.height+30);
        this.g.beginPath();
        ...
        this.g.fillText(this.p.toFixed(3)+" W", this.startx+this.width/4, this.y+this.height/3+12);
    }
    setR(r:number){
        this.r=r;
